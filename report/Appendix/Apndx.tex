\chapter{Code and Interfaces Appendix}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{Chapter5/Figures/annotated_frame.png}
\caption{Real-time Annotated Video Feed with bounding boxes, tracking trails, and LSTM trajectory prediction markers.}
\end{figure}
